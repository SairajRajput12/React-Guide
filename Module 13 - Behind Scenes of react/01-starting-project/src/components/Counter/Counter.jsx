...
const Counter =  memo(function Counter({ initialCount }) {
  ...
  const initialCountIsPrime = useMemo(() => isPrime(initialCount),[initialCount]);  // this function get's rexecuted when initialCount changes 
  
  // useEffect(() => {
  //     setCounterChanges([{value:initialCount,id:Math.random()*1000}]); 
  // },[initialCount]); -> not efficient apporoach 
